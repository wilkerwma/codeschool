...
class Migration(migrations.Migration):
    ...
    replaces = [('cs_questions', '0001_initial'), ('cs_questions', '0002_auto_20160501_1934'), ('cs_questions', '0003_remove_codingioresponse_feedback'), ('cs_questions', '0004_auto_20160501_2349')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cs_core.ProgrammingLanguage')),
                ('question_fallback', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='cs_questions.CodingIoQuestion')),
            ],
            options={
                'abstract': False,
            },
